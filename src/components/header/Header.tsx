...
import { ICart, IConfig, IDeliveryOption, IProduct } from "../../model/config";
...
const Header = (): ReactElement => {
    ...
    const { response: productsFromApi, error: productsError, loading: loadingProducts, fetchData: fetchProducts } = useHttpGet__<IProduct[]>(ENDPOINTS[API.PRODUCTS]());
